...
public class ModMCTThread extends Thread implements Constants {
    ...
    private static int penaltyScore = 500, penaltyTime = 100;
...
//	private static Random rand = new Random();
    ...
    public ModMCTThread(TreeNode root, int gId, KNNAgent pseudoAgent, ModifiedGhostTeamBot gTeam, int numThreads, int pPathScore, int pScore) {
